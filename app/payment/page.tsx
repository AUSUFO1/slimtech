...
export default function PaymentPage() {
  ...
  const handlePayment = async (e: React.FormEvent) => {
    ...
    try {
      const paymentPayload = {
        ...
        currency: "NGN",
        description: `SlimTech Mentorship Bootcamp - ${
          applicationData.track || "General"
        }`,
  ...
  return (
    ...
    >
      ...
      <div
        className="w-full md:w-1/2 lg:w-1/2 flex items-center justify-center p-6 md:p-8 lg:p-12 relative"
        style={{ backgroundColor: "#F5F5F5" }}
      >
